    ...
    <footer className="mt-16 py-2">
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Link
            href="/"
            className="flex items-center gap-3 p-4 rounded-lg border border-[var(--border)] hover:border-[var(--primary)] hover:shadow-md transition-all duration-200 group"
          >
        ...
        <div className="flex justify-center gap-4 mb-8">
          <Link
            ...
            className="p-3 rounded-lg border border-[var(--border)] hover:border-gray-400 hover:shadow-md transition-all duration-200 group"
            title="GitHub"
          >
            <FaGithub className="text-xl text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors" />
          </Link>

          <Link
            href="mailto:sungjong5k@naver.com"
            className="p-3 rounded-lg border border-[var(--border)] hover:border-blue-400 hover:shadow-md transition-all duration-200 group"
            title="Contact"
          >
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 rounded-lg border border-[var(--border)] hover:border-pink-400 hover:shadow-md transition-all duration-200 group"
            title="Instagram"
          >
